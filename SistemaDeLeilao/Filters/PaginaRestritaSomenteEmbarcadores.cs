...
{
    public class PaginaRestritaSomenteEmbarcadores : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            else
            {
                ...
                if( !(usuario.Perfil == Enums.PerfilEnum.Embarcadores || usuario.Perfil == Enums.PerfilEnum.Admin) )
                {
